...
export const poLanding: PoLandingContent = {
  ...
  metrics: [
    ...
    },
    {
      value: '2',
      unit: '×',
      label: { ko: '스타트업 창업 및 매각', en: 'Startups founded and acquired' },
  ...
  experience: {
    ...
    items: [
      ...
      },
      {
        ...
        roleTag: { ko: '공동창업자 겸 CTO — 지분 매각', en: 'Co-founder & CTO — Acquired' },
        ...
        tags: ['풀스택', 'WebSocket', 'MySQL', '지분 매각'],
        exit: true,
      },
      {
        id: 'osof',
        ...
        roleTag: { ko: '공동창업자 겸 대표 — 사업 매각', en: 'Co-founder & CEO — Acquired' },
  ...
  cases: {
    ...
    items: [
      ...
      },
      {
        slug: 'paik',
        num: 'CASE 03',
        title: { ko: '외국인 부동산 플랫폼 0 → 1, 그리고 매각', en: 'Real-estate platform for foreign residents: 0 to 1, then acquired' },
        body: {
          ko: '언어 장벽으로 한국 부동산 시장 접근이 어려운 외국인 문제를 포착. 에이전트-고객 실시간 연결 플랫폼을 기획부터 개발까지 주도했고 2021년 지분을 매각했다.',
          en: "Identified the problem of foreign residents locked out of Korea's real-estate market by the language barrier. Led a real-time agent-client matching platform from planning through development, then sold my equity in 2021.",
        },
        metric: {
          value: '매각',
      ...
      },
      {
        ...
        body: {
          ko: '광주 지역 초중학생 대상 소프트웨어 교육 공백 발견. 컴퓨팅 사고력 중심 커리큘럼 개발, 실습 프로젝트 운영으로 STEM 관심 증진. 2년 6개월 운영한 뒤 사업과 지분을 매각했다.',
          en: 'Found a gap in software education for middle- and elementary-school students in Gwangju. Built a computational-thinking curriculum and ran hands-on projects to build STEM interest. Ran continuously for two and a half years, then sold the business.',
        },
        metric: {
          value: '2.5',
