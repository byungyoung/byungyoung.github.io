window.I18N = {
  ko: {
    ...
    "ql.q1.desc":   "rPPG 기술로 얼굴 영상에서 감정 상태를 비접촉 분석. 선행 연구 기준 92%를 설계 목표로.",
    "ql.q1.status": "ACTIVE",
    ...
    "ql.q3.desc":   "AI 영어 튜터링 UX 개선. 학습 효율 +20%, 사용성 평가 85점.",
    "ql.q3.status": "DONE",
    ...
    "skills.ach2.name": "AI Builder",     "skills.ach2.desc": "rPPG 파이프라인 설계",
    ...
    "projects.p2.desc":  "AI 기반 영어 튜터링. UX 개선으로 사용성 평가 85점.",
  ...
  en: {
    ...
    "ql.q1.desc":   "Non-contact emotion analysis from facial video via rPPG. Designed against the ~92% accuracy reported in the literature.",
    "ql.q1.status": "ACTIVE",
    "ql.q2.title":  "Refactor Works — Dev Experience Manager",
    ...
    "ql.q3.desc":   "Improved AI English tutoring UX. +20% learning efficiency, 85 usability score.",
    "ql.q3.status": "DONE",
    "ql.q4.title":  "Paik — CTO",
    ...
    "skills.ach.label": "Achievements Unlocked",
    "skills.ach1.name": "Serial Founder", "skills.ach1.desc": "2× Exit",
    "skills.ach2.name": "AI Builder",     "skills.ach2.desc": "rPPG pipeline design",
    ...
    "projects.p2.name":  "Lingora AI Tutor",
    "projects.p2.desc":  "AI-based English tutoring. 85 usability score via UX improvements.",
